...
def resource_path(relative_path):
    """Get absolute path to resource (for dev & PyInstaller .exe)"""
    try:
...
class ChickenKiosk(tk.Frame):
    def __init__(self, master):
        super().__init__(master, bg="#282c73")
        self.root = master
        self.root.title("Pastil Kiosk - Chicken Menu")
        self.root.configure(bg="#282c73")
        ...
        # --- IMAGES ---
        self.images = {
            1: self.load_image(resource_path("images/regular.jpg")),
            2: self.load_image(resource_path("images/spicy.jpg")),
            3: self.load_image(resource_path("images/regular.jpg")),
            4: self.load_image(resource_path("images/spicy.jpg"))
        }
